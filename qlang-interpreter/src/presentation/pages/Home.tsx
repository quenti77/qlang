...
export default function Home() {
    ...
    return (
        <div className="m-2 grid grid-rows-3 grid-cols-4 gap-2 h-[calc(100vh-4rem)]">
            <div className="hidden lg:block lg:row-start-1 lg:row-span-3 lg:col-span-2 xl:col-span-1">
                <HelpTile />
            </div>
            ...
            <div className="row-start-3 row-span-1 col-span-4 lg:col-span-2 xl:col-span-3">
